...
<div class="wrap dsf-admin-dashboard">
    ...
    <a href="<?php echo admin_url('admin.php?page=dsf-editor'); ?>" class="page-title-action">
        Add New Page
    </a>
    ...
    <div class="dsf-dashboard-grid" style="display: grid; grid-template-columns: 2fr 1fr; gap: 20px; margin-top: 20px;">
        ...
        <div class="dsf-card" style="background: white; border: 1px solid #c3c4c7; border-radius: 4px; padding: 20px;">
            ...
            <?php if (empty($pages)): ?>
                <div style="text-align: center; padding: 40px; color: #646970;">
                    ...
                    <a href="<?php echo admin_url('admin.php?page=dsf-editor'); ?>" class="button button-primary">
            ...
            <?php else: ?>
                    ...
                    <tbody>
                        <?php foreach ($pages as $page): ?>
                            <tr>
                                <td>
                                    <strong>
                                        <a href="<?php echo admin_url('admin.php?page=dsf-editor&post_id=' . $page->ID); ?>">
                                ...
                                <td>
                                    <?php 
                                    $status_label = $page->post_status === 'publish' ? 'Published' : ucfirst($page->post_status);
                                    $status_color = $page->post_status === 'publish' ? '#00a32a' : '#d63638';
                                    ?>
                                ...
                                <td>
                                    <?php echo human_time_diff(strtotime($page->post_modified), current_time('timestamp')) . ' ago'; ?>
                                </td>
                                <td>
                                    <a href="<?php echo admin_url('admin.php?page=dsf-editor&post_id=' . $page->ID); ?>">
                                        Edit
                ...
                <p style="margin-top: 16px;">
                    <a href="<?php echo admin_url('edit.php?post_type=dsf_page'); ?>">
                        View all pages →
                    </a>
                </p>
            <?php endif; ?>
        ...
        <div>
            <div class="dsf-card" style="background: white; border: 1px solid #c3c4c7; border-radius: 4px; padding: 20px; margin-bottom: 20px;">
                ...
                <ul style="margin: 0;">
                    <li style="margin-bottom: 12px;">
                        <a href="<?php echo admin_url('admin.php?page=dsf-editor'); ?>" style="display: flex; align-items: center; gap: 8px; text-decoration: none;">
                            <span class="dashicons dashicons-plus-alt2"></span>
                            Create New Page
                        </a>
                    </li>
                    <li style="margin-bottom: 12px;">
                        <a href="<?php echo admin_url('admin.php?page=dsf-settings'); ?>" style="display: flex; align-items: center; gap: 8px; text-decoration: none;">
                            <span class="dashicons dashicons-admin-settings"></span>
                            Plugin Settings
                        </a>
                    </li>
                    <li>
                        <a href="https://designstudio.com/flow/docs" target="_blank" style="display: flex; align-items: center; gap: 8px; text-decoration: none;">
            ...
            <div class="dsf-card" style="background: #f0f6fc; border: 1px solid #c3c4c7; border-radius: 4px; padding: 20px;">
                ...
                <a href="https://designstudio.com/flow/pro" target="_blank" class="button button-primary">
                    Learn More
                </a>
            </div>
        </div>
