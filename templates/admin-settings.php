...
if (isset($_POST['dsf_save_settings']) && wp_verify_nonce($_POST['dsf_settings_nonce'], 'dsf_save_settings')) {
    // Save settings
    $enabled_post_types = isset($_POST['dsf_enabled_post_types']) ? array_map('sanitize_text_field', $_POST['dsf_enabled_post_types']) : [];
...
$enabled_post_types = get_option('dsf_enabled_post_types', ['page', 'dsf_page']);
$default_colors = get_option('dsf_default_colors', [
    'primary' => '#3B82F6',
    'secondary' => '#1E40AF',
    'text' => '#1F2937',
    'background' => '#FFFFFF',
                        ...
                        <td>
                            <label style="display: block; margin-bottom: 8px;">
                                <input type="checkbox" name="dsf_enabled_post_types[]" value="page" 
                                    <?php checked(in_array('page', $enabled_post_types)); ?>>
                                Pages
                            </label>
                            <label style="display: block; margin-bottom: 8px;">
                                <input type="checkbox" name="dsf_enabled_post_types[]" value="dsf_page" 
                                    <?php checked(in_array('dsf_page', $enabled_post_types)); ?>>
