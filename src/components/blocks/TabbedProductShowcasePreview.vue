  ...
  <section class="dsf-tabbed-showcase" :class="[`dsf-tabbed-showcase--${presentationStyle}`, `dsf-tabbed-showcase--tab-style-${tabStyle}`]" :style="sectionStyle">
    <div class="dsf-tabbed-showcase__inner">
          ...
          <article v-for="(item, index) in visibleItems" :key="item.id || index" class="dsf-tabbed-showcase__card">
            <a :href="itemHref(item)" class="dsf-tabbed-showcase__card-link" @click="handleLinkClick">
              ...
              <template v-else>
                ...
                <InlineText v-if="isEditor || activeTab.supportingText" v-model="activeTab.supportingText" tagName="p" class="dsf-tabbed-showcase__card-supporting" :is-editor="isEditor" placeholder="Optional supporting text" />
              </template>
            </a>
          </article>
          </div>
      ...
      <div v-if="settings.showButtons !== false" class="dsf-tabbed-showcase__actions">
        <a :href="safeActionUrl(settings.primaryUrl)" class="dsf-tabbed-showcase__button" @click="handleLinkClick"><InlineText v-model="settings.primaryText" tagName="span" :is-editor="isEditor" placeholder="Explore All" /></a>
        <a :href="safeActionUrl(settings.secondaryUrl)" class="dsf-tabbed-showcase__button" @click="handleLinkClick"><InlineText v-model="settings.secondaryText" tagName="span" :is-editor="isEditor" placeholder="Learn More" /></a>
      </div>
    </div>
  </section>
</template>
...
.dsf-tabbed-showcase__title { margin: 0 0 2rem; color: var(--dsf-tabbed-showcase-title-color); font-family: var(--dsf-theme-heading-font, inherit); font-size: clamp(2rem, 3.5vw, 3rem); font-weight: 700; line-height: 1.1; }
.dsf-tabbed-showcase__description { max-width: 720px; margin: -1rem auto 2rem; color: #64748b; font-size: clamp(1rem, 1.5vw, 1.2rem); line-height: 1.45; }
...
.dsf-tabbed-showcase__tab { padding: 0; border: 0; background: transparent; color: var(--dsf-tabbed-showcase-accent); font: inherit; font-weight: 700; cursor: pointer; }
.dsf-tabbed-showcase__tab:not(.is-active) { color: var(--dsf-tabbed-showcase-title-color); }
.dsf-tabbed-showcase__tab.is-active::after { display: block; width: 0; height: 0; margin: 0.7rem auto -1.7rem; border-right: 10px solid transparent; border-left: 10px solid transparent; border-top: 14px solid var(--dsf-tabbed-showcase-title-color); content: ''; }
.dsf-tabbed-showcase__separator { color: var(--dsf-tabbed-showcase-title-color); font-weight: 700; }
...
.dsf-tabbed-showcase__card-supporting { margin: 0.35rem 0 0; color: var(--dsf-tabbed-showcase-title-color); font-size: 0.9rem; line-height: 1.3; }
.dsf-tabbed-showcase__actions { display: flex; justify-content: center; gap: 1.25rem; margin-top: 3rem; }
.dsf-tabbed-showcase__button { min-width: 280px; padding: 0.85rem 1.5rem; border-radius: 0.75rem; background: var(--dsf-tabbed-showcase-theme-primary); color: #fff; font-weight: 700; text-decoration: none; }
...
.dsf-tabbed-showcase--tabs .dsf-tabbed-showcase__tab { padding: 0.75rem 1.25rem; color: #64748b; font-weight: 600; }
.dsf-tabbed-showcase--tabs .dsf-tabbed-showcase__tab.is-active { color: var(--dsf-tabbed-showcase-title-color); box-shadow: inset 0 -3px 0 var(--dsf-tabbed-showcase-accent); }
...
.dsf-tabbed-showcase--tab-style-modern .dsf-tabbed-showcase__tabs { gap: 0.5rem; margin-bottom: 3rem; padding: 0.35rem; border-radius: 999px; background: #f3f4f6; }
.dsf-tabbed-showcase--tab-style-modern .dsf-tabbed-showcase__tab { padding: 0.7rem 1.2rem; border-radius: 999px; color: #64748b; font-size: 0.95rem; transition: color 0.2s ease, background 0.2s ease, box-shadow 0.2s ease; }
.dsf-tabbed-showcase--tab-style-modern .dsf-tabbed-showcase__tab.is-active { background: #fff; color: var(--dsf-tabbed-showcase-title-color); box-shadow: 0 2px 8px rgba(15, 23, 42, 0.12); }
...
.dsf-tabbed-showcase--tab-style-underline .dsf-tabbed-showcase__tab { padding: 0.8rem 1.25rem 0.95rem; color: #64748b; font-weight: 600; }
.dsf-tabbed-showcase--tab-style-underline .dsf-tabbed-showcase__tab.is-active { color: var(--dsf-tabbed-showcase-title-color); box-shadow: inset 0 -3px 0 var(--dsf-tabbed-showcase-accent); }
...
.dsf-tabbed-showcase--tab-style-chevron .dsf-tabbed-showcase__tab { position: relative; padding: 0.7rem 0.25rem 1rem; color: #64748b; font-weight: 600; }
.dsf-tabbed-showcase--tab-style-chevron .dsf-tabbed-showcase__tab.is-active { color: var(--dsf-tabbed-showcase-title-color); }
...
@container (max-width: 760px) { .dsf-tabbed-showcase__tabs { margin-bottom: 2.5rem; gap: 0.8rem 1rem; } .dsf-tabbed-showcase__cards { grid-template-columns: repeat(2, minmax(0, 1fr)); } .dsf-tabbed-showcase__actions { flex-direction: column; align-items: center; } }
