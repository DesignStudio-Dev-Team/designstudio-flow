<template>
  <section id="engagement" ref="root" class="dsf-engagement-suite" :style="blockStyle">
    <div class="dsf-engagement-suite__heading">
      <InlineText v-if="settings.showEyebrow !== false" tagName="span" v-model="settings.eyebrow" :is-editor="isEditor" data-dsf-reveal placeholder="Eyebrow" />
...
.dsf-engagement-suite__heading > span { color: var(--dsf-eyebrow-color, #fff); font-size: var(--dsf-eyebrow-size, 12px); font-weight: 850; letter-spacing: 0.13em; text-transform: uppercase; }
