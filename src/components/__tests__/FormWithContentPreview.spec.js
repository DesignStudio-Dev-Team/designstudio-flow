...
describe('FormWithContentPreview', () => {
  ...
  it('injects late Gravity Forms layout overrides for embedded forms', async () => {
    ...
    expect(style.textContent).toContain('width: 25px !important')
    ...
    expect(style.textContent).toContain('gap: .625rem !important')
    expect(style.textContent).toContain('line-height: 1.35 !important')
