import{$ as e,A as t,Dt as n,I as r,L as i,M as a,N as ee,P as o,St as s,W as c,Y as l,_ as u,b as d,h as f,jt as p,k as m,lt as h,t as g,v as _,wt as v,x as y,y as b}from"./_plugin-vue_export-helper-DPkvz0M9.js";import{c as x}from"./main-BJVAgOxo.js";import{t as S}from"./InlineText-DTcxNUX7.js";var C=p({default:()=>D});h(),m(),l();var w={key:0,class:`dsf-form-with-content__header`},te=[`contenteditable`],ne={key:0,class:`dsf-form-with-content__media-wrap`},re=[`src`],ie=[`src`],ae={key:2,class:`dsf-form-with-content__video-wrap`},oe={class:`dsf-form-with-content__video dsf-form-with-content__video--file`,autoplay:``,muted:``,loop:``},se=[`src`,`type`],ce={key:3,class:`dsf-form-with-content__video-wrap`},le=[`src`],ue={key:1,class:`dsf-form-with-content__video-placeholder`},de={key:0,class:`dsf-form-with-content__form-placeholder`},fe={class:`dsf-form-with-content__form-name`},pe={class:`dsf-form-with-content__code`},me=[`innerHTML`],he={key:1,class:`dsf-form-with-content__empty`},ge=[`innerHTML`],_e={key:1,class:`dsf-form-with-content__empty`},T=`dsf-form-with-content-gravity-overrides`,E=`<p><b>Your dream backyard starts here!</b></p><p>Fill out the form and we'll be in touch as soon as possible.</p>`,D=g({__name:`FormWithContentPreview`,props:{settings:{type:Object,default:()=>({})},isEditor:{type:Boolean,default:!1},previewMode:{type:String,default:`desktop`}},setup(l){let p=l,m=t(`dsfRenderMode`,`live`),h=e(null),g=e(null),C=e(``),D=null,O=null,k=null,A=!1,j=u(()=>p.settings?.formSide||`right`),M=u(()=>p.settings?.formSource||`dsf`),N=u(()=>M.value!==`embed`),P=u(()=>{let e=x(p.settings||{},p.previewMode,`padding`)??60,t=x(p.settings||{},p.previewMode,`paddingX`)??24;return{backgroundColor:p.settings?.backgroundColor||`#FFFFFF`,padding:`${e}px ${t}px`}}),F=u(()=>{let e=p.settings?.columnRatio||`1-1`,t=`minmax(0, 1fr) minmax(0, 1fr)`;return e===`3-2`?t=j.value===`left`?`minmax(0, 2fr) minmax(0, 3fr)`:`minmax(0, 3fr) minmax(0, 2fr)`:e===`2-3`&&(t=j.value===`left`?`minmax(0, 3fr) minmax(0, 2fr)`:`minmax(0, 2fr) minmax(0, 3fr)`),t}),I=u(()=>({backgroundColor:p.settings?.contentBg||`#FFFFFF`})),ve=u(()=>({color:p.settings?.textColor||`#1F2937`})),ye=u(()=>({backgroundColor:p.settings?.formBg||`#FFFFFF`})),L=u(()=>p.settings?.mediaType===`image`),R=u(()=>L.value&&!!p.settings?.image),z=u(()=>!L.value&&!!p.settings?.videoFile),B=u(()=>!L.value&&!!V.value),be=u(()=>{let e=(p.settings?.videoFile||``).toLowerCase();return e.endsWith(`.webm`)?`video/webm`:e.endsWith(`.ogg`)||e.endsWith(`.ogv`)?`video/ogg`:`video/mp4`}),V=u(()=>{let e=(p.settings?.video||``).trim();if(!e)return``;if(e.includes(`/embed/`)||e.includes(`player.vimeo.com`))return e;let t=e.match(/youtu\.be\/([^?&]+)/);if(t)return`https://www.youtube.com/embed/${t[1]}`;let n=e.match(/[?&]v=([^&]+)/);if(n)return`https://www.youtube.com/embed/${n[1]}`;let r=e.match(/shorts\/([^?&]+)/);if(r)return`https://www.youtube.com/embed/${r[1]}`;let i=e.match(/vimeo\.com\/(\d+)/);return i?`https://player.vimeo.com/video/${i[1]}`:``}),xe=typeof window<`u`&&window.dsfEditorData?.forms||[],H=u(()=>{let e=p.settings?.formId,t=Number.parseInt(e,10);return Number.isFinite(t)&&t>0?String(t):``}),Se=u(()=>(p.settings?.formTitle||``).trim()||(H.value?xe.find(e=>String(e?.id||``)===H.value)?.title||`Form #${H.value}`:`No form selected`)),Ce=u(()=>H.value?`[dsform id='${H.value}']`:`[dsform id='']`),U=u(()=>p.settings?.renderedFormHtml||``),W=u(()=>N.value?``:p.settings?.renderedEmbedHtml||p.settings?.embedCode||``),G=u(()=>N.value||!Array.isArray(p.settings?.renderedEmbedScripts)?[]:p.settings.renderedEmbedScripts),K=u(()=>G.value.length?JSON.stringify(G.value.map(e=>e?.code||``)):``);function q(){p.isEditor||m===`snapshot`||A||!U.value&&!W.value||!h.value||(we(),J(),typeof window?.dsfInitForms==`function`&&window.dsfInitForms(h.value),Ee(),J(),De())}function we(){if(typeof document>`u`)return;let e=document.getElementById(T);e&&e.remove();let t=document.createElement(`style`);t.id=T,t.textContent=`
...
`,document.head.appendChild(t)}function J(){let e=h.value;e&&(e.querySelectorAll(`.akismet-fields-container`).forEach(e=>{e.setAttribute(`hidden`,``),e.setAttribute(`aria-hidden`,`true`)}),e.querySelectorAll(`.gform_wrapper legend, .gform_wrapper legend.gfield_label, .gform_wrapper.gravity-theme legend.gfield_label`).forEach(e=>{e.style.setProperty(`margin-bottom`,`0`,`important`),e.style.setProperty(`margin-block-end`,`0`,`important`)}),e.querySelectorAll(`.gform_wrapper`).forEach(e=>{let t=e.querySelector(`.gform_heading .gform_required_legend`),n=e.querySelector(`.gf_progressbar_title`);!t||!n||n.contains(t)||(t.classList.add(`dsf-gform-required-legend--inline`),n.appendChild(t))}))}function Te(e){if(typeof document>`u`||!e||A)return;let t=new DOMParser().parseFromString(e,`text/html`),n=Array.from(t.querySelectorAll(`script`));if(!n.length)return;let r=JSON.stringify(n.map(e=>e.textContent||``));C.value!==r&&(C.value=r,Y(n.map(e=>({code:e.textContent||``}))))}function Ee(){if(N.value){if(!U.value)return;Te(U.value)}else{if(!G.value.length||!K.value||C.value===K.value)return;C.value=K.value,Y(G.value)}}function Y(e,t=0){if(!A){if(e.some(e=>/\bgform\b|gravity_form|gform_wrapper/.test(e?.code||``))&&typeof window<`u`&&!window.gform&&t<80){k=window.setTimeout(()=>{k=null,Y(e,t+1)},50);return}e.forEach(e=>{let t=(e?.code||``).trim();if(!t)return;let n=document.createElement(`script`);n.type=`text/javascript`,n.text=t,document.body.appendChild(n),n.remove()}),X()}}function X(){let e=h.value;if(!e||typeof window>`u`)return;let t=e.querySelectorAll(`.gform_wrapper`);t.length&&t.forEach(e=>{let t=(e.id||``).match(/gform_wrapper_(\d+)/),n=t?Number.parseInt(t[1],10):0;if(!n)return;let r=e.querySelector(`form`),i=Number.parseInt(r?.querySelector(`input[name^='gform_source_page_number_']`)?.value,10)||1;if(window.jQuery)try{window.jQuery(document).trigger(`gform_post_render`,[n,i])}catch{}if(window.gform&&typeof window.gform.doAction==`function`)try{window.gform.doAction(`gform_post_render`,n,i)}catch{}})}function De(){p.isEditor||D||typeof window>`u`||(D=(e,t)=>{J(),Z(t)},O=e=>{J(),Z(e?.detail?.formId)},window.jQuery&&window.jQuery(document).on(`gform_page_loaded`,D),document.addEventListener(`gform/ajax/post_page_change`,O))}function Z(e){let t=h.value;if(!t||typeof window>`u`)return;let n=Number.parseInt(e,10);if(Number.isFinite(n)&&n>0&&!t.querySelector(`#gform_${n}`))return;let r=t.getBoundingClientRect().top+window.pageYOffset-24;window.scrollTo({top:Math.max(r,0),behavior:`smooth`})}function Q(){if(!g.value)return;let e=p.settings?.content||E;g.value.innerHTML!==e&&(g.value.innerHTML=e)}function $(){if(!p.isEditor||!g.value)return;let e=g.value.innerHTML;e!==p.settings?.content&&(p.settings.content=e)}function Oe(e){if(!p.isEditor)return;e.preventDefault();let t=e.clipboardData?.getData(`text/plain`)||``,n=window.getSelection();n?.rangeCount&&(n.deleteFromDocument(),n.getRangeAt(0).insertNode(document.createTextNode(t)),n.collapseToEnd(),$())}return o(()=>{Q(),a(q)}),r(()=>a(q)),c(()=>p.settings?.content,()=>{typeof document<`u`&&document.activeElement===g.value||Q()}),ee(()=>{A=!0,k!==null&&(clearTimeout(k),k=null),typeof window<`u`&&window.jQuery&&D&&window.jQuery(document).off(`gform_page_loaded`,D),typeof document<`u`&&O&&document.removeEventListener(`gform/ajax/post_page_change`,O)}),(e,t)=>(i(),y(`div`,{class:`dsf-block-preview dsf-form-with-content`,style:v(P.value)},[l.isEditor||l.settings.sectionTitle||l.settings.showDivider?(i(),y(`div`,w,[l.isEditor||l.settings.sectionTitle?(i(),b(S,{key:0,tagName:`h2`,class:`dsf-form-with-content__section-title`,style:v({color:l.settings.titleColor||`#1F2937`}),modelValue:l.settings.sectionTitle,"onUpdate:modelValue":t[0]||=e=>l.settings.sectionTitle=e,"is-editor":l.isEditor,placeholder:`Enter Section Title`},null,8,[`style`,`modelValue`,`is-editor`])):d(``,!0),l.settings.showDivider?(i(),y(`hr`,{key:1,class:`dsf-form-with-content__divider`,style:v({borderColor:l.settings.dividerColor||`#E5E7EB`})},null,4)):d(``,!0)])):d(``,!0),_(`div`,{class:s([`dsf-form-with-content__grid`,j.value===`left`?`dsf-form-with-content__grid--form-left`:`dsf-form-with-content__grid--form-right`]),style:v({"--grid-cols":F.value})},[_(`div`,{class:`dsf-form-with-content__col dsf-form-with-content__col--content`,style:v(I.value)},[_(`div`,{ref_key:`contentEditor`,ref:g,class:s([`dsf-form-with-content__content`,{"dsf-form-with-content__content--editable":l.isEditor}]),style:v(ve.value),contenteditable:l.isEditor,spellcheck:`true`,onBlur:$,onPaste:Oe},null,46,te),R.value||z.value||B.value?(i(),y(`div`,ne,[l.settings.logo?(i(),y(`img`,{key:0,src:l.settings.logo,class:s([`dsf-form-with-content__logo`,{"dsf-form-with-content__logo--padded":l.settings.logoPadding}]),alt:`Logo`},null,10,re)):d(``,!0),R.value?(i(),y(`img`,{key:1,src:l.settings.image,class:`dsf-form-with-content__image`,alt:``},null,8,ie)):z.value?(i(),y(`div`,ae,[_(`video`,oe,[_(`source`,{src:l.settings.videoFile,type:be.value},null,8,se)])])):B.value?(i(),y(`div`,ce,[_(`iframe`,{src:V.value,class:`dsf-form-with-content__video`,frameborder:`0`,allow:`autoplay; fullscreen; picture-in-picture`,allowfullscreen:``},null,8,le)])):d(``,!0)])):l.settings.video&&l.isEditor&&!L.value.value?(i(),y(`div`,ue,[_(`span`,null,`Video: `+n(l.settings.video),1)])):d(``,!0)],4),_(`div`,{class:`dsf-form-with-content__col dsf-form-with-content__col--form`,style:v(ye.value)},[N.value?(i(),y(f,{key:0},[l.isEditor?(i(),y(`div`,de,[t[1]||=_(`div`,{class:`dsf-form-with-content__badge`},` DesignStudio Flow Form `,-1),_(`div`,fe,n(Se.value),1),t[2]||=_(`p`,{class:`dsf-form-with-content__hint`},` The live form will render here on the frontend. `,-1),_(`code`,pe,n(Ce.value),1)])):(i(),y(`div`,{key:1,ref_key:`frontendRoot`,ref:h,class:`dsf-form-with-content__form-frontend`,"data-dsf-form-with-content-form":``},[U.value?(i(),y(`div`,{key:0,innerHTML:U.value},null,8,me)):(i(),y(`div`,he,n(H.value?`Form preview is loading.`:`Select a form in the block settings.`),1))],512))],64)):(i(),y(`div`,{key:1,ref_key:`frontendRoot`,ref:h,class:`dsf-form-with-content__form-frontend`,"data-dsf-form-with-content-form":``},[W.value?(i(),y(`div`,{key:0,innerHTML:W.value},null,8,ge)):(i(),y(`div`,_e,` Add your content in the block settings. `))],512))],4)],6)],4))}},[[`__scopeId`,`data-v-1fb5d5e5`]]);export{C as n,D as t};